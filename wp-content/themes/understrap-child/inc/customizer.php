...
//Footer Contact Us customizer
add_action( 'customize_register', 'footer_contact_us_customizer' );
function footer_contact_us_customizer( $wp_customize ) {
	//adding section in wordpress customizer
	$wp_customize->add_section( 'footer_contact_us_section', array(
		'title'       => __( 'Footer Contact Us' ),
		'description' => __( 'Contact Us text, address and phone' )
	) );
	...
	$wp_customize->add_control( 'description_text', array(
		...
		'section'  => 'footer_contact_us_section',
		'type'     => 'text',
